...
namespace FirstMlNetProgram.Data
{
    public class RegressionData
    {
        ...
        public static List<InsuranceData> GetInsuranceData()
        {
            return new List<InsuranceData>
            {
                new InsuranceData{Age = 10,Premium = 1500}, // Sample data points label:Premium, Feature:Age
                new InsuranceData{Age = 20,Premium = 4500},
